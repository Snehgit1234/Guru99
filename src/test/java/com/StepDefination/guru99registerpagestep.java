...
import PageLayer.guru99registerpage;
import io.cucumber.datatable.DataTable;
import io.cucumber.java.en.Given;
import io.cucumber.java.en.Then;
public class guru99registerpagestep extends BaseClass{

	public static guru99registerpage guru99;
	...
	public void user_enter_firstname_lastname_phone_email(DataTable dataTable) {
		...
		guru99=new guru99registerpage();
		guru99.contactInfoFunctionality(fisrtname, lastname, phonenum, email);
	...
	public void user_enters_address_city_state_pincode_and_country(DataTable dataTable) {
		...
		guru99.mailingFunctionality(address, city, state, postalcode, cntry);
	}
	...
	public void user_enter_username_and_password_and_confirm_password_and_click_on_submit_button(DataTable dataTable) {
		...
		guru99.userInfoFunctionality(username, password, cinfirmpass);
	}
}
